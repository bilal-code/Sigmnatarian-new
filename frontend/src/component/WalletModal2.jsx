                    ...
                    <ul className="my-4 space-y-3">
                      <li>
                        <a
                          ...
                          className=" flex cursor-pointer items-center p-3 text-base font-bold text-gray-900 bg-gray-200 rounded-lg  group hover:shadow-lg "
                        >
                          <svg
                            aria-hidden="true"
                            className="h-8"
                      ...
                      <li>
                        <a
                          ...
                          className="cursor-pointer flex items-center p-3 text-base font-bold text-gray-900 bg-gray-200 rounded-lg  group hover:shadow-lg "
                        >
                          <svg
                            aria-hidden="true"
                            className="h-8"
                      ...
                      <li>
                        <a
                          onClick={conToWallet}
                          className="cursor-pointer flex items-center p-3 text-base font-bold text-gray-900 bg-gray-200  rounded-lg hover:bg-gray-100 group hover:shadow-lg"
                        >
                          <svg
                            aria-hidden="true"
                            className="h-12"

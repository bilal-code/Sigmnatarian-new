export const DiaAddress = process.env.NEXT_PUBLIC_DIA_ADDRESS;
export const MatrixAddress = process.env.NEXT_PUBLIC_MATRIX_ADDRESS;
export const ActiveChain = process.env.NEXT_PUBLIC_ACTIVE_CHAIN;

export const clientId = process.env.NEXT_PUBLIC_CLIENT_ID;
export const AddressZero = process.env.NEXT_PUBLIC_ZERRO_ADDRESS;
